...
async function updateDocumentIntoDatabase(userName, documentType, documentId,document_path) {
    try {
        ...
        const url = 'mongodb+srv://su:CT9EQLax7Hj9wYj9@cluster0.d0wmo43.mongodb.net/?retryWrites=true&w=majority';
        let client;
        let userSchema = {
            userName: userName,
...
async function verifyFileExistenceAndHash(documentId, documentType, collectionName) {
    try {
        ...
        const mongoURI = `mongodb+srv://su:CT9EQLax7Hj9wYj9@cluster0.d0wmo43.mongodb.net/?retryWrites=true&w=majority/EHR`;
